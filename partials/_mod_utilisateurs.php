<div class="espace_mod">
    ...
    <p class="valid">
        <?php 
            if(isset($_SESSION['VALIDATE_MESSAGE_SIGNAL_UTILISATEUR'])) {
                echo $_SESSION['VALIDATE_MESSAGE_SIGNAL_UTILISATEUR'];
                $_SESSION['VALIDATE_MESSAGE_SIGNAL_UTILISATEUR'] = '';
            }
        ?>
    </p>
    <p class="error">
        <?php 
            if(isset($_SESSION['ERROR_MESSAGE_SIGNAL_UTILISATEUR'])) {
                echo $_SESSION['ERROR_MESSAGE_SIGNAL_UTILISATEUR'];
                $_SESSION['ERROR_MESSAGE_SIGNAL_UTILISATEUR'] = '';
            }
        ?>
    </p>
    <p class="valid">
